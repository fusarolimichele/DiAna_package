...
test_that("Disproportionality trend works also using quarters and months", {
  ...
  expect_equal(
    ...
    c(
      ...
      "Inf (5.42-Inf) [4]", "Inf (5.53-Inf) [4]", "Inf (5.56-Inf) [4]",
      "Inf (5.15-Inf) [4]", "Inf (4.95-Inf) [4]", "Inf (4.84-Inf) [4]",
      "Inf (4.89-Inf) [4]", "Inf (5-Inf) [4]", "Inf (5.09-Inf) [4]",
      "Inf (6.35-Inf) [5]", "Inf (6.43-Inf) [5]", "Inf (6.54-Inf) [5]",
      "Inf (6.43-Inf) [5]", "Inf (6.54-Inf) [5]", "Inf (6.62-Inf) [5]",
      "Inf (6.7-Inf) [5]", "Inf (6.78-Inf) [5]", "Inf (8.72-Inf) [6]",
      "Inf (8.86-Inf) [6]", "Inf (8.96-Inf) [6]", "Inf (8.91-Inf) [6]",
      "Inf (8.59-Inf) [6]", "Inf (8.55-Inf) [6]", "Inf (8.48-Inf) [6]",
      "Inf (8.6-Inf) [6]", "Inf (8.66-Inf) [6]", "Inf (8.93-Inf) [6]",
      "Inf (9.23-Inf) [6]", "Inf (9.41-Inf) [6]", "Inf (9.53-Inf) [6]",
