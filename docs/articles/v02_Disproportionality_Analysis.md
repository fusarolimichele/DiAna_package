...
![Fig 1: IC (aripiprazole , ICD)](render_forest-1.png)
...
![Fig 2: ROR (aripiprazole , ICD)](render_forest-2.png)
...
![Fig 3: IC (aripiprazole , ICD_query)](render_query-1.png)
...
![Fig 5: IC (aripiprazole , ICD_query_with_behaviors), and controls,
looking only at suspected agents.](only_suspect-1.png)
...
#>               <num> <fctr>       <num>     <num>       <fctr>    <int>   <fctr>                    <fctr>
#>        1:  45217461      M        9855        NA         <NA> 19861106       MD  United States of America
#>        2:  57910401   <NA>          NA        NA         <NA>       NA     <NA>  United States of America
#>        3:  56962401   <NA>          NA        NA         <NA> 19960123     <NA>  United States of America
#>        4:  54662121      F       22630        NA         <NA> 19960919       CN South Africa, Republic of
#>        5:  31231172      F       21535        68         <NA> 19970927       MD  United States of America
#>       ---                                                                                                
#> 17598475: 236937711      F        9490        68         <NA> 20240318       CN  United States of America
#> 17598476: 236937721      M        6205        NA         <NA> 20240101       CN  United States of America
#> 17598477: 236937741      F       13140       134         <NA> 20240322       CN  United States of America
#> 17598478: 237079261      F       15695        90         <NA>       NA       CN  United States of America
#> 17598479: 237079291      M       22265       108         <NA> 20240228       CN  United States of America
#>           rept_cod init_fda_dt   fda_dt premarketing literature RB_duplicates RB_duplicates_only_susp
#>             <fctr>       <int>    <int>       <lgcl>     <lgcl>        <lgcl>                  <lgcl>
#>        1:      DIR    19861224 19861224        FALSE      FALSE         FALSE                   FALSE
#>        2:      DIR    19920917 19920917        FALSE      FALSE         FALSE                   FALSE
#>        3:      DIR    19960126 19960126        FALSE      FALSE         FALSE                   FALSE
#>        4:      EXP    19961022 19961022        FALSE      FALSE         FALSE                   FALSE
#>        5:      EXP    19971203 19971212        FALSE      FALSE         FALSE                   FALSE
#>       ---                                                                                            
#> 17598475:      DIR    20240331 20240331        FALSE      FALSE         FALSE                   FALSE
#> 17598476:      DIR    20240331 20240331        FALSE      FALSE         FALSE                   FALSE
#> 17598477:      DIR    20240331 20240331        FALSE      FALSE         FALSE                   FALSE
#> 17598478:      DIR    20240331 20240331        FALSE      FALSE         FALSE                   FALSE
#> 17598479:      DIR    20240331 20240331        FALSE      FALSE         FALSE                   FALSE
```
...
data.](deduplication_algorithms-1.png)
...
#>                                                         hlgt                                           hlt
#>                                                       <char>                                        <char>
#>     1:        metabolic and nutritional disorders congenital            inborn errors of steroid synthesis
#>     2:          endocrine investigations (incl sex hormones)                 reproductive hormone analyses
#>     3:          endocrine investigations (incl sex hormones)                 reproductive hormone analyses
#>     4:          endocrine investigations (incl sex hormones)                 reproductive hormone analyses
#>     5:          endocrine investigations (incl sex hormones)                 reproductive hormone analyses
#>    ---                                                                                                    
#> 25408:     procedural related injuries and complications nec    non-site specific procedural complications
#> 25409: pregnancy, labour, delivery and postpartum conditions         normal pregnancy, labour and delivery
#> 25410:   obstetric and gynaecological therapeutic procedures                 cervix therapeutic procedures
#> 25411:             male genital tract therapeutic procedures male genital tract therapeutic procedures nec
#> 25412:                            white blood cell disorders                        eosinophilic disorders
#>                                      pt
#>                                  <char>
...
![Fig 8: IC (aripiprazole , ICD_query_with_behaviors \| bipolar
disorder_HLGT), and controls, looking only at suspected
agents.](retrieve_with_MedDRA-1.png)

Fig 8: IC (aripiprazole , ICD_query_with_behaviors \| bipolar
disorder_HLGT), and controls, looking only at suspected agents.
...
![Fig 9: IC (aripiprazole , ICD_query_with_behaviors \| bipolar
disorder_HLGT), and controls, looking only at suspected agents before
warning.](notoriety_bias-1.png)
...
#>               <num>   <fctr>    <int>      <fctr>  <fctr>   <char> <fctr>  <char>    <int> <char>
#>        1:  45217461       HP  4521746           1       I     <NA>      N    <NA>       NA   <NA>
#>        2:  57910401     <NA>  5791040           1       I     <NA>      N    <NA>       NA   <NA>
#>        3:  56962401     <NA>  5696240           1       I     <NA>      N    <NA>       NA   <NA>
#>        4:  54662121      FGN  5466212           1       I     <NA>      N    <NA> 19961015   <NA>
#>        5:  54662121       HP  5466212           1       I     <NA>      N    <NA> 19961015   <NA>
#>       ---                                                                                        
#> 18283734: 236937711      CSM 23693771           1       I   697702      N    <NA> 20240331      N
#> 18283735: 236937721      CSM 23693772           1       I   697662      N    <NA> 20240331      N
#> 18283736: 236937741      CSM 23693774           1       I   697678      N    <NA> 20240331   <NA>
#> 18283737: 237079261      CSM 23707926           1       I   697660      N    <NA> 20240331      Y
#> 18283738: 237079291      CSM 23707929           1       I   697693      N    <NA> 20240331      Y
#>                   mfr_sndr     mfr_num   mfr_dt quarter
#>                     <char>      <char>    <int>  <fctr>
#>        1:             <NA>        <NA>       NA    20Q3
#>        2:             <NA>        <NA>       NA    20Q3
#>        3:             <NA>        <NA>       NA    20Q3
#>        4: ELI LILLY AND CO ZA96101984A 19961010    20Q3
#>        5: ELI LILLY AND CO ZA96101984A 19961010    20Q3
#>       ---                                              
#> 18283734:          FDA-CTU        <NA> 20240331    24Q1
#> 18283735:          FDA-CTU        <NA> 20240331    24Q1
#> 18283736:          FDA-CTU        <NA> 20240331    24Q1
#> 18283737:          FDA-CTU        <NA> 20240331    24Q1
#> 18283738:          FDA-CTU        <NA> 20240331    24Q1
## Disproportionality analysis ----------------------------------------------------------
...
warning.](disproportionality_trend-1.png)
