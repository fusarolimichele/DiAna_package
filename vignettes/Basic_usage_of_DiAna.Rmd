...
knitr::kable(head(individual_cases), caption = "Example of individual_cases")
individual_cases_drug <- readxl::read_xlsx(paste0(project_path,"individual_cases_drug.xlsx"))
knitr::kable(head(individual_cases_drug), caption = "Example of individual_cases_drug")
```

#Descriptive

{r cases_retrieval, eval=FALSE}# retrieve the cases into an excel for
individual assessmentretrieve(pids_cases, file_name =
paste0(project_path, "individual_cases"))
