...
Table: Tab 1: MedDRA Preferred Terms including the substring impuls.
...
Table: Tab 2: Disproportionality dataframe structure.
...
Table: Tab 3: Disproportionality results when extending the query to impulsivity.
...
Table: Tab 4: Disproportionality results when considering also specific behaviors.
...
![Fig 4: IC (aripiprazole , ICD_query_with_behaviors)](multiple_definitions-1.png)
...
Table: Tab 5: Disproportionality results when considering positive and negative controls.
...
![Fig 5: IC (aripiprazole , ICD_query_with_behaviors), and controls](including_controls-1.png)
...
Table: Tab 6: Disproportionality results when considering only suspected drugs.
...
![Fig 5: IC (aripiprazole , ICD_query_with_behaviors), and controls, looking only at suspected agents.](only_suspect-1.png)
...
Table: Tab 7: Disproportionality results when considering deduplication algorithms.
...
![Fig 6: IC (aripiprazole , ICD_query_with_behaviors), and controls, looking only at suspected agents and deduplicated data.](deduplication_algorithms-1.png)
...
Table: Tab 8: Disproportionality results when considering only reports recording bipolar disorder.
...
![Fig 7: IC (aripiprazole , ICD_query_with_behaviors | bipolar disorder), and controls, looking only at suspected agents.](retrieve_bipolar-1.png)
...
Table: Tab 9: Disproportionality results when restricting to bipolar disorder using MedDRA.
...
![Fig 8: IC (aripiprazole , ICD_query_with_behaviors | bipolar disorder_HLGT), and controls, looking only at suspected agents.](retrieve_with_MedDRA-1.png)
...
Table: Tab 10: Disproportionality results when addressing notoriety bias.
...
![Fig 9: IC (aripiprazole , ICD_query_with_behaviors | bipolar disorder_HLGT), and controls, looking only at suspected agents before warning.](notoriety_bias-1.png)
...
![Fig 10: IC trend (aripiprazole , ICD_query_with_behaviors), looking only at suspected agents before warning.](disproportionality_trend-1.png)
