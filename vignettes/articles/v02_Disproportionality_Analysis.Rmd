...
resource_files:
  ...
  - 'figure/render_forest-1.png'
  - 'render_forest-1.png'
  - '../man/figures/render_forest-1.png'
  - 'man/figures/render_forest-1.png'
---
...
knitr::include_graphics("../man/figures/render_forest-1.png", dpi = 144)
#> Error in knitr::include_graphics("../man/figures/render_forest-1.png", : Cannot find the file(s): "../man/figures/render_forest-1.png"
knitr::include_graphics("man/figures/render_forest-1.png", dpi = 144)
#> Error in knitr::include_graphics("man/figures/render_forest-1.png", dpi = 144): Cannot find the file(s): "man/figures/render_forest-1.png"
knitr::include_graphics("../man/figures/render_forest-2.png", dpi = 144)
#> Error in knitr::include_graphics("../man/figures/render_forest-2.png", : Cannot find the file(s): "../man/figures/render_forest-2.png"
knitr::include_graphics("man/figures/render_forest-2.png", dpi = 144)
#> Error in knitr::include_graphics("man/figures/render_forest-2.png", dpi = 144): Cannot find the file(s): "man/figures/render_forest-2.png"
```
